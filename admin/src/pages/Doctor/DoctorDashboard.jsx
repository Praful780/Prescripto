  ...
  return dashData && (
    <div className='m-5'>
      ...
      <div className='flex flex-wrap gap-3'>
        ...
        <div className='flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer hover:scale-105 hover:border-primary transition-all'>
          <img className='w-14 rounded hover:border border-primary' src={assets.earning_icon} alt=""/>
          <div>
        ...
        <div className='flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer hover:scale-105 hover:border-primary transition-all'>
          <img className='w-14 rounded hover:border border-primary' src={assets.appointments_icon} alt=""/>
            <div>
        ...
        <div className='flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer hover:scale-105 hover:border-primary transition-all'>
          <img className='w-14 rounded hover:border border-primary' src={assets.patients_icon} alt=""/>
          <div>
