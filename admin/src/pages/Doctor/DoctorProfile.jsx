    ...
    <div>
      ...
      <div className='flex flex-col gap-4 m-5'>
        ...
        <div className='flex-1 border border-stone-300 rounded-lg p-8 py-7 bg-white'>
          ...
          {/* Doctor`s Info: name, degree, experience....*/}
          ...
          <p className='text-gray-800 font-medium mt-4'>
            Appointment fee: <span className='text-gray-900'>{currency} { isEdit ? <input type="number" onChange={(e) => setProfileData(prev => ({...prev, fees: e.target.value}))} value={profileData.fees} /> :  profileData.fees}</span>
          </p>
